# Problem 04 - Hybrid Encoder Projectors

## Description
- Mapping multi-scale CNN backbones to uniform hidden dimensions.
- This module corresponds to `hybrid_encoder.py` in the final D-FINE repository phase.
